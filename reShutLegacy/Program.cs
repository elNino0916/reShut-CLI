...
namespace reShutLegacy
{
    ...
    { 
        ...
        start:
            ...
            Console.WriteLine(".NET 8.0 Desktop Runtime is required after the next update (v.12.0.0)");
            Console.WriteLine("Install .NET 8.0 now to prevent any errors after the release of v.12.0.0.");
            Console.WriteLine("Download .NET 8 here:");
            Console.ForegroundColor=ConsoleColor.Blue;
            Console.WriteLine("https://dotnet.microsoft.com/en-us/download/dotnet/thank-you/runtime-desktop-8.0.0-windows-x64-installer");
            Console.WriteLine("\n");
